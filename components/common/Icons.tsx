...
export const LeafIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M13 8V2.5A2.5 2.5 0 0 1 15.5 0L17 1.5 22.5 7A2.5 2.5 0 0 1 20 9.5V13a7 7 0 0 1-7 7z" />
  </svg>
);

export const MarketIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 12H2" /><path d="M22 12h-2" /><path d="m15 5-1-1" /><path d="m9 5 1-1" />
    <path d="M17 21H7a2 2 0 0 1-2-2v-3h14v3a2 2 0 0 1-2 2Z" /><path d="M21 16H3" />
...
export const ScaleIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m16 16-4-4-4 4" /><path d="M12 22V12" />
    <path d="M4 6h16" /><path d="M6 6l-3 6h3" /><path d="M18 6l3 6h-3" />
  </svg>
);
...
export const WindIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M17.7 7.7a2.5 2.5 0 1 0-3.5-3.5" />
        <path d="M9.6 12.6a2.5 2.5 0 1 0-3.5-3.5" />
        <path d="M17.7 17.7a2.5 2.5 0 1 0-3.5-3.5" />
        <path d="M2 12h7" />
        <path d="M14 12h8" />
        <path d="M2 7h2" />
        <path d="M11 18h11" />
...
export const BrainCircuitIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 2a10 10 0 0 0-1.76 6.23" />
    <path d="M12 2a10 10 0 0 1 1.76 6.23" />
    <path d="M2 12h2.5" />
    <path d="M19.5 12H22" />
    <path d="M12 22v-2.5" />
    <path d="M12 4.5V2" />
    <path d="M4.76 4.76l1.76 1.76" />
    <path d="M17.48 17.48l1.76 1.76" />
    <path d="M4.76 19.24l1.76-1.76" />
    <path d="M17.48 6.52l1.76-1.76" />
    <circle cx="12" cy="12" r="2" />
    <path d="M4.5 9.5a4.5 4.5 0 0 0 0 5" />
    <path d="M19.5 9.5a4.5 4.5 0 0 1 0 5" />
    <path d="M9.5 4.5a4.5 4.5 0 0 0 5 0" />
    <path d="M9.5 19.5a4.5 4.5 0 0 1 5 0" />
  </svg>
);
...
export const SproutIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="m12 4-2 2" />
    <path d="m12 4 2 2" />
    <path d="M12 14s-2-2-2-4 2-4 2-4" />
    <path d="M12 14s2-2 2-4-2-4-2-4" />
  </svg>
);
